  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless car sharing with Car Sharing Application - Your key to unlocking a world of convenient and eco-friendly travel."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless car sharing with Car Sharing Application - Your key to unlocking a world of convenient and eco-friendly travel.`}
            </Text>
            <Box
